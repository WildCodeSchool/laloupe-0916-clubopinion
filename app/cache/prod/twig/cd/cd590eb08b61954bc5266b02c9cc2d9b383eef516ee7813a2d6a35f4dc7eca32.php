...
class __TwigTemplate_8c9fdbdb086ad8152d67b88f258fc5d44d5495e72ac84f7459009eaaf94549ee extends Twig_Template
{
...
";
    ...
    <h1><img src=\"";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["av2"]) ? $context["av2"] : null), "titleAv2", array()), "html", null, true);
        echo "</h1>
    <span class=\"bold\">Titre</span>
    ";
        // line 68
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "titleAv2", array()), 'errors');
        echo "
    ";
        // line 69
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "titleAv2", array()), 'widget');
        echo "
        ...
        <div class=\"row blockGray\">
            <div class=\"row\"><!--**************** 2ème bloc *****************-->
                <div class=\"col-xxs-12 col-xs-6 homepageBlock2\">
                    <p>";
        // line 76
        echo $this->getAttribute((isset($context["av2"]) ? $context["av2"] : null), "paragraphAv2", array());
        echo "</p>
                    <br>
                    <span class=\"bold\">Paragraphe</span>
                    ";
        // line 79
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "paragraphAv2", array()), 'errors');
        echo "
                    ";
        // line 80
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "paragraphAv2", array()), 'widget');
        echo "
                    <input type=\"submit\" value=\"Modifier\" />
                </div>
                <div class=\"col-xxs-12 col-xs-6 homepageBlock2\">
                    <img src=\"";
        // line 84
        echo twig_escape_filter($this->env, $this->env->getExtension('Vich\UploaderBundle\Twig\Extension\UploaderExtension')->asset((isset($context["av2"]) ? $context["av2"] : null), "image", "ClubBundle\\Entity\\av2"), "html", null, true);
...
";
    ...
    {
        return array (  240 => 92,  231 => 86,  227 => 85,  223 => 84,  216 => 80,  212 => 79,  206 => 76,  196 => 69,  192 => 68,  185 => 66,  181 => 65,  177 => 64,  173 => 62,  170 => 61,  165 => 58,  152 => 51,  144 => 48,  138 => 47,  132 => 46,  121 => 40,  115 => 39,  109 => 38,  98 => 32,  92 => 31,  86 => 30,  80 => 29,  74 => 28,  68 => 27,  47 => 11,  39 => 5,  35 => 4,  32 => 3,  29 => 2,  11 => 1,);
    }
    ...
    {
        return new Twig_Source("", "ClubBundle:av2:edit.html.twig", "/var/www/html/projets/clubdelopinion/src/ClubBundle/Resources/views/av2/edit.html.twig");
    }
}
