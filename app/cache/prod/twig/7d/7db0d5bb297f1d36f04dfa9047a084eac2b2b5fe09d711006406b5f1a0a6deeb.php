...
class __TwigTemplate_ed9b22bcdcea5188920892e73df87c6fff09c6f3a5c9fd63858aa473471bb60b extends Twig_Template
{
...
";
    ...
    <h1><i class=\"fa fa-newspaper-o fa-1x\" aria-hidden=\"true\"></i> ";
        // line 67
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["av1"]) ? $context["av1"] : null), "titleAv1", array()), "html", null, true);
        echo "</h1>
    <span class=\"bold\">Titre</span>
    ";
        // line 69
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "titleAv1", array()), 'errors');
        echo "
    ";
        // line 70
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "titleAv1", array()), 'widget');
        echo "
    ...
    <div class=\"container-fluid\">
        <div class=\"row blockGray\"><!--******************* 1er bloc ***************-->
            <div class=\"col-xxs-12 col-xs-6 homepageBlock2\">
                <img src=\"";
        // line 76
        echo twig_escape_filter($this->env, $this->env->getExtension('Vich\UploaderBundle\Twig\Extension\UploaderExtension')->asset((isset($context["av1"]) ? $context["av1"] : null), "image", "ClubBundle\\Entity\\av1"), "html", null, true);
        ...
        echo "
            ...
            <div class=\"col-xxs-12 col-xs-6 homepageBlock2\">
                <p>";
        // line 82
        echo $this->getAttribute((isset($context["av1"]) ? $context["av1"] : null), "paragraphAv1", array());
        echo "</p>
                <br>
                <span class=\"bold\">Paragraphe</span>
                ";
        // line 85
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "paragraphAv1", array()), 'errors');
        echo "
                ";
        // line 86
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["edit_form"]) ? $context["edit_form"] : null), "paragraphAv1", array()), 'widget');
        echo "
                <input type=\"submit\" value=\"Modifier\" />
            </div>
        </div>
...
";
    ...
    {
        return array (  238 => 92,  229 => 86,  225 => 85,  219 => 82,  212 => 78,  208 => 77,  204 => 76,  195 => 70,  191 => 69,  186 => 67,  181 => 65,  177 => 64,  173 => 62,  170 => 61,  165 => 58,  152 => 51,  144 => 48,  138 => 47,  132 => 46,  121 => 40,  115 => 39,  109 => 38,  98 => 32,  92 => 31,  86 => 30,  80 => 29,  74 => 28,  68 => 27,  47 => 11,  39 => 5,  35 => 4,  32 => 3,  29 => 2,  11 => 1,);
    }
    ...
    {
        return new Twig_Source("", "ClubBundle:av1:edit.html.twig", "/var/www/html/projets/clubdelopinion/src/ClubBundle/Resources/views/av1/edit.html.twig");
    }
}
